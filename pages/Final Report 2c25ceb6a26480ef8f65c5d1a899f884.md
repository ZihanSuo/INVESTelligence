...
### 5.2.1. Layer 1: Semantic Materiality (LLM-Driven)
...
### 5.2.2. Layer 2: Quantitative Quality (Python-Driven)
...
### 5.4.1 The Architecture: GitHub as a Database
...
### 6.2.1 Level 1: Impact vs. Market Sentiment
...
### 6.2.2 Level 2: The Alpha Quadrant (Credibility vs. Materiality)
...
### 6.2.3 Level 3: Consensus & Context
...
### 6.2.4 Level 4: The Smart Ticker
